...
public class CalendarBookingAssetRenderer
	...
	// Code Changes for ADT
	public CalendarBooking getCalBooking(){
		return _calendarBooking;
	} 
	
	public String getCalStartDate(){
		
		java.util.Calendar startTimeJCalendar = JCalendarUtil.getJCalendar(_calendarBooking.getStartTime());
		SimpleDateFormat startDate = new SimpleDateFormat("dd");
		
		return startDate.format(startTimeJCalendar.getTime()).toString();
	}
public String getCalStartDateMonth(){
		
		java.util.Calendar startTimeJCalendar = JCalendarUtil.getJCalendar(_calendarBooking.getStartTime());
		SimpleDateFormat startDate = new SimpleDateFormat("MMM");
		
		return startDate.format(startTimeJCalendar.getTime()).toString();
	}
	public String getCalEndDate(){
		
		java.util.Calendar endTimeJCalendar = JCalendarUtil.getJCalendar(_calendarBooking.getEndTime());
		SimpleDateFormat endDate = new SimpleDateFormat("MM/dd/yyyy");
		
		return endDate.format(endTimeJCalendar.getTime()).toString();
	}
public String getCalStartTime(){
		...
		return startTime.format(startTimeJCalendar.getTime()).toString();
	}
	public String getCalEndTime(){
		...
		return endTime.format(endTimeJCalendar.getTime()).toString();
	}
	...
	public boolean isExpired(){
		...
		java.util.Date calStartDate= startTimeJCalendar.getTime();
		
		if(calStartDate.after(todaysDate)){
			expired=false;
		}
