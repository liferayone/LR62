...
public class CalendarBookingLocalServiceImpl
	...
	public CalendarBooking addCalendarBooking(
		...
		calendarBooking.setCreateDate(startTimeJCalendar.getTime());
		calendarBooking.setModifiedDate(endTimeJCalendar.getTime());
	...
	/*
	 * Corporate Calendar Method to retreive the list directly.
*/
	public List<CalendarBooking> getCorporateCalendarListView(long calendarId) throws SystemException{
		List<CalendarBooking> futureEvents=null;
		Date now= new Date();
		//OrderByComparator obc = OrderByComparatorFactoryUtil.create(CalendarBookingImpl.TABLE_NAME, "startTime" , true);
		futureEvents= CalendarBookingUtil.findByC_S(calendarId, CalendarBookingWorkflowConstants.STATUS_APPROVED);
