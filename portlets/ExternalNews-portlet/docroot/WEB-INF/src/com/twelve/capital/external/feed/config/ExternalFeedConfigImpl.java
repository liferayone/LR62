 ...
 * 
 */
package com.twelve.capital.external.feed.config;
...
public class ExternalFeedConfigImpl extends DefaultConfigurationAction {
...
//    javax.portlet.PortletPreferences prefs = PortletPreferencesFactoryUtil.getPortletSetup(actionRequest, portletResource); 
	javax.portlet.PortletPreferences prefs = new ScopedPreferencesServiceImpl().getUserSpecificPortletSpecificPreferences(actionRequest);
    System.out.println("=============getAutoFieldsData==");
	String phonesIndexesStr = actionRequest.getParameter("phonesIndexes");
	System.out.println("=============phonesIndexesString=="+phonesIndexesStr);
	int[] phonesIndexes = StringUtil.split(phonesIndexesStr, 0);

	for (int phonesIndex : phonesIndexes) {
		String externalFeedUrl = ParamUtil.getString(actionRequest, "externalFeedUrl" + phonesIndex);
		System.out.println("=============externalFeedUrl=="+externalFeedUrl);
	    //prefs.setValue("externalFeedUrl", externalFeedUrl);
	    //prefs.store();	   
