...
/**
 * Provides the local service interface for GreetingsMessage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author neha.kakkar
 * @see GreetingsMessageLocalServiceUtil
...
public interface GreetingsMessageLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GreetingsMessageLocalServiceUtil} to access the greetings message local service. Add custom service methods to {@link com.twelve.capital.greetings.service.service.impl.GreetingsMessageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
