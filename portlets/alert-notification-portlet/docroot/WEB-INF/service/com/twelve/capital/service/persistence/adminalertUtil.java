...
/**
 * The persistence utility for the adminalert service. This utility wraps {@link adminalertPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class adminalertUtil {
	 ...
	 */
	public static void clearCache(adminalert adminalert) {
		getPersistence().clearCache(adminalert);
	}
	 ...
	 */
	public static List<adminalert> findWithDynamicQuery(
	 ...
	 */
	public static adminalert update(adminalert adminalert)
		throws SystemException {
		return getPersistence().update(adminalert);
	}
	...
	public static adminalert update(adminalert adminalert,
		...
		return getPersistence().update(adminalert, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(adminalert);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(adminalerts);
	}
	...
	*/
	public static com.twelve.capital.model.adminalert create(long alertId) {
	...
	*/
	public static com.twelve.capital.model.adminalert remove(long alertId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.twelve.capital.NoSuchadminalertException {
		return getPersistence().remove(alertId);
	}

	public static com.twelve.capital.model.adminalert updateImpl(
		com.twelve.capital.model.adminalert adminalert)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(adminalert);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.twelve.capital.model.adminalert findByPrimaryKey(
		long alertId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.twelve.capital.NoSuchadminalertException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.twelve.capital.model.adminalert fetchByPrimaryKey(
		long alertId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.twelve.capital.model.adminalert> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static adminalertPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (adminalertPersistence)PortletBeanLocatorUtil.locate(com.twelve.capital.service.ClpSerializer.getServletContextName(),
					adminalertPersistence.class.getName());

			ReferenceRegistry.registerReference(adminalertUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(adminalertPersistence persistence) {
	}

	private static adminalertPersistence _persistence;
}